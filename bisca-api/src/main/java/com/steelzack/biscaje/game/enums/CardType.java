...
public enum CardType {
    ...
    NUMERIC_6_PT_(6, 0, DeckType.PORTUGUESE), //
    NUMERIC_7_PT_(7, 10, DeckType.PORTUGUESE), //
    NUMERIC_8_PT_(8, 0, DeckType.PORTUGUESE), //
    NUMERIC_9_PT_(9, 0, DeckType.PORTUGUESE), //
    NUMERIC_10_PT_(10, 0, DeckType.PORTUGUESE), //
    NUMERIC_Q_PT_(11, 2, DeckType.PORTUGUESE), //
    NUMERIC_J_PT_(12, 3, DeckType.PORTUGUESE), //
    NUMERIC_K_PT_(13, 4, DeckType.PORTUGUESE); //
